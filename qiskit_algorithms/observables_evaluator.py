...
from qiskit.primitives import BaseEstimatorV2  # change: BaseEstimator migrated to BaseEstimatorV2
...
def estimate_observables(
    estimator: BaseEstimatorV2,  # change: BaseEstimator migrated to BaseEstimatorV2
